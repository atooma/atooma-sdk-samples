...
/**
 * Un filtro per i valori percentuali.
 */
public class PercentFilter implements Serializable {
	 ...
	 */
	public PercentFilter(int type, Integer match) {
		this.type = type;
		this.match = match;
	}
	...
	/**
	 * Filtra una numero secondo la definizione di questo {@link PercentFilter},
	 ...
	 *         altrimenti false
	 */
	public boolean filter(Integer test) {
